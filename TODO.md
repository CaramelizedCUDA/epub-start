...
- 当前已形成候选冻结清单 [B3_CONTRACT_FREEZE.md](B3_CONTRACT_FREEZE.md)；Windows 与 B2 Android 后端范围已关闭，arm64 设备空白安装/首次启动证据已补齐，仍因 B3 固定样本集运行时占用、release 私有 data 精确分项和正式 release 签名未签发。

...
2026-09-15 当前工作进入首版代码收口：先完成 Windows/Android 编译和相关自动检查，发行前集中开展交付测试。范围与交接见 [首版代码交接](docs/EPUB_CODE_READY_2026-09-15.md)。
...
标签管理与筛选前端已接入后端契约，真实写入、重启恢复及跨端交互仍待阶段验收。目录、搜索、批注、手势和阅读计时在不同设备上的覆盖范围不相同，具体限制见 [当前任务与验收状态](TODO.md)。
